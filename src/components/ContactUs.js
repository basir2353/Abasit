    ...
    <section className="contact-section">
      <div className="contact-content">
        ...
        <div className="contact-options">
          <h1>Email: <a href="mailto:reachsagarshah@gmail.com">reachsagarshah@gmail.com</a></h1>
          <h1> <RiPhoneLine size={18} />Phone: +91 8980500565 <span className="copy-icon" onClick={copyPhoneNumber}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard2-check" viewBox="0 0 16 16">
